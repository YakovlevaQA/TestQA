...
*Заполнение поля Организация из соглашения
	И Я открываю навигационную ссылку "e1cib/list/Document.SalesOrder"
	И я нажимаю на кнопку с именем 'FormCreate'
	И я жду открытия окна "Заказ покупателя (создание)" в течение 10 секунд
	И я нажимаю кнопку выбора у поля с именем "Agreement"
	И я жду открытия окна "Соглашения" в течение 10 секунд
	И в таблице "List" я перехожу к строке:
		| 'Наименование'                                         |
		| 'Общее соглашение (расчет по стандартным соглашениям)' |
	И в таблице "List" я выбираю текущую строку
*Проверка поля Организация, если оно заполненно	
	Если элемент формы с именем "Agreement" стал равен "Общее соглашение" в течение 10 секунд Тогда
		И элемент формы с именем "Company" стал равен 'Собственная компания 1'
*Шаги в случае, если поле Организация не заполненно 
